...
const ANNOUNCEMENTS: Announcement[] = [
  {
    ...
    id: "neko-feature-release-v4",
    title: "网站更新公告 · 最近攒了一堆新东西，还养了两只会唠嗑的小猫",
    content:
      "攒了一堆新东西，挑几个你可能用得上的：\n" +
      "· 首页那两只小猫会说话了。心情不一样，语气、点头的幅度、旁边小灯的呼吸都不一样\n" +
      "· 戳一下、摸个头、拎起来拖，她都有反应；拖到栏目上说对应的话，拎到窗口外面能跑到隔壁那只身边\n" +
      "· 「指令速查」输关键词就能搜指令，点一下直接复制\n" +
      "· 「在线状态」一眼看清 neko 的账号和后台服务还活着没，账号被腾讯下线会单独标红\n" +
      "· 找指令点导航栏的 neko 头像，或按 Ctrl+Shift+K；懒得打字就点麦克风，边说边出字\n" +
      "· 彩蛋在文档站和功能站点亮都算数，两边进度互通\n" +
      "· 功能站的聊天框和文档站是同一个，答法也一样\n" +
  ...
  },
  {
    ...
    title: "群聊邀请 · 小猫窝地下室",
    content:
      "欢迎来「✦小猫窝地下室✩」玩。网站更新会发在群里，指令不会用也可以直接问。",
    showOnce: false,
    actions: [
      {
        text: "加入群聊",
